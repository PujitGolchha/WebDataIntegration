 ...
 * 
 */
public class AlbumBlockingKeyByTitleStartGenerator extends
	...
	public void generateBlockingKeys(Song record, Processable<Correspondence<Attribute, Matchable>> correspondences,
		...
		String token  = record.getAlbum_name();

		String blockingKeyValue = token.substring(0, Math.min(4,token.length())).toUpperCase();
