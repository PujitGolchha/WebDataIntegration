 ...
 * 
 */
public class SongDateComparatorWeightedSimilarity implements Comparator<Song, Attribute> {

	private static final long serialVersionUID = 1L;
	private WeightedDateSimilarity sim = new WeightedDateSimilarity(0.1, 0.2, 0.7);
