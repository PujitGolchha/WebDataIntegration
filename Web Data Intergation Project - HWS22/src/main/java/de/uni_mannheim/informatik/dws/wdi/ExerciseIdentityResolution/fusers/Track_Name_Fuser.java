...
public class Track_Name_Fuser extends AttributeValueFuser<String, Song, Attribute> {

    public Track_Name_Fuser() {
    ...
    public void fuse(RecordGroup<Song, Attribute> group, Song fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
        ...
        fusedRecord.setTrack_name(fused.getValue());
        fusedRecord.setAttributeProvenance(Song.Track_Name,
