...
/**
 * {@link Comparator} for {@link Song}s based on the {@link Song#getAlbum_name()} ()}
 * value and their {@link MaximumOfTokenContainment} value.
 * 
 * @author Abhay, Pujit
 * 
 */
public class AlbumTitleComparatorContainment implements Comparator<Song, Attribute> {
	...
	public double compare(
		...
		String s1 = record1.getAlbum_name().toLowerCase().replaceAll("\\p{Punct}","");
		String s2 = record2.getAlbum_name().toLowerCase().replaceAll("\\p{Punct}","");
