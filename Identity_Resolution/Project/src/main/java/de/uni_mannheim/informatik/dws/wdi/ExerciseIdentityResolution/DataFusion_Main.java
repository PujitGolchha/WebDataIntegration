...
public class DataFusion_Main 
{
	...
	public static void main( String[] args ) throws Exception
    {
		...
		correspondences.loadCorrespondences(new File("data/correspondences/song_correspondences_dez_musico.csv"),dataDeezer, dataMusico);
		correspondences.loadCorrespondences(new File("data/correspondences/song_correspondences_dez_spotify.csv"),dataDeezer, dataSpotify);
		correspondences.loadCorrespondences(new File("data/correspondences/song_correspondences_spot_musico.csv"),dataSpotify, dataMusico);
		...
		new SongXMLReader().loadFromXML(new File("data/goldstandard/gold.xml"), "/movies/movie", gs);
